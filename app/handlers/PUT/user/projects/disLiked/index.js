...
// dislike :: Collection:db -> String:credential -> String:projectId -> Promise(String, Error)
const dislike = require('../../../../../User/User.js').removeLikedProject;

// sendResponse :: Request -> Response -> String:projectId -> Response
const sendResponse = curry((request, reply, projectId) => {
  request.log('/user/projects/disLiked',
...
module.exports = (request, reply) => {
  ...
  isAuthenticated(request)
    .then(get('projectId'))
    .then(isProjectValid)
    .then(dislike(collection, credential))
